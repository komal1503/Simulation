    ...
    <div>
      <div className="heads">
        <div className="heading">
          <h1>
            Welcome, Now you have to input the data to calculate utilization
          </h1>
        </div>
      ...
      <div className="main">
        <button className="input" onClick={handleNavigation}>
          INPUT DATA
        </button>
        ...
        <div className="calc">
          <div className="adj">
            ...
            <button className="adjbtn" onClick={Adj_Calculations}>
              Adjuster Calculations
            </button>
          </div>
          <div className="mc">
