        ...
        return(
            ...
            <div className='page'>
                ...
                <img src={image} className="avatar"/>
                    <h1>Login</h1>
                   <div className='cred'> <input type="email" id="email" name="email" placeholder="email"
                    ...
                    <button className='login' onClick={(e) => this.changeMode("Login", e)}><b>Login</b></button>
                    <h4>Don't have an account?</h4>
                    <button className='login' onClick={(e) => this.changeMode("Signup", e)}><b>Signup</b></button>
                    </div>
                </form>
            </div>
        )
